...
export default function VolunteerAllocationPage() {
  ...
  const { teams: allTeams, isLoadingTeams, refetchTeams } = useTeams();
  ...
  const rawTeams = reliefStationId ? inStationTeams : allTeams;
  const isLoadingTeamList = reliefStationId ? isLoadingInStationTeams : isLoadingTeams;
  const refetchTeamList = reliefStationId ? refetchInStationTeams : refetchTeams;
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row">
          <div className="flex flex-col gap-2">
            ...
            <p className="max-w-2xl text-base font-normal text-muted-foreground">
              Lấy danh sách tình nguyện viên chưa vào đội từ hệ thống, chọn nhiều người cùng lúc và
              thêm vào team phụ trách phù hợp.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="group flex flex-col gap-3 rounded-xl border border-border bg-card p-6 shadow-sm transition-colors hover:border-primary/50">
            ...
            <div className="flex items-end gap-3">
              <p className="text-4xl font-black leading-none text-foreground">{stats.waiting}</p>
            ...
            <div className="border-b border-slate-200 bg-slate-50 p-4 dark:border-border dark:bg-card">
              <div className="mb-4 flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 rounded-full border border-border bg-background px-3 py-1 text-xs text-muted-foreground">
                  <Checkbox checked={allVisibleSelected} onCheckedChange={handleToggleAllVisible} />
              ...
              <div className="flex flex-wrap gap-2">
                {(['all', 'health', 'rescue', 'logistics'] as AllocationFilter[]).map((item) => {
          ...
          <div className="flex flex-[2] flex-col gap-4">
            <div className="mb-2 flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Chọn 1 team để thêm cùng lúc {selectedVolunteerIds.size} tình nguyện viên đã chọn.
                </p>
              </div>
              <Button
                variant="outline"
            ...
            <div className="custom-scrollbar grid grid-cols-1 gap-4 overflow-y-auto pb-2 pr-2 xl:grid-cols-2">
              {isLoadingTeamList ? (
                ...
                <div className="col-span-full rounded-xl border border-border bg-card p-8 text-center text-muted-foreground">
                  <span className="material-symbols-outlined mb-2 text-4xl opacity-50">groups</span>
                    ...
                    >
                      ...
                      <div className="mb-6 space-y-3">
                        <div className="mb-1 flex justify-between text-sm">
                          ...
                          <span className="font-medium text-foreground">{team.members} / 20</span>
                        </div>
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          className="gap-2"
                          disabled={selectedVolunteerIds.size === 0 || !isSelectedTeam || isSaving}
                          onClick={handleAssignSelected}
                        >
